    ...
    <Layout>
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-card border-2 border-warning/20 hover:border-warning rounded-2xl p-6 transition-colors">
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 bg-warning rounded-xl flex items-center justify-center">
                <ClockIcon className="w-6 h-6 text-warning-foreground" />
              </div>
              <span className="text-sm font-medium text-muted-foreground">Pending</span>
            </div>
            <div className="cost-display text-warning mb-1">
          ...
          <div className="bg-card border-2 border-info/20 hover:border-info rounded-2xl p-6 transition-colors">
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 bg-info rounded-xl flex items-center justify-center">
                <div className="w-6 h-6 border-2 border-info-foreground border-t-transparent rounded-full animate-spin" />
              </div>
              <span className="text-sm font-medium text-muted-foreground">Processing</span>
            </div>
            <div className="cost-display text-info mb-1">
          ...
          <div className="bg-card border-2 border-success/20 hover:border-success rounded-2xl p-6 transition-colors">
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 bg-success rounded-xl flex items-center justify-center">
                <CheckCircleIcon className="w-6 h-6 text-success-foreground" />
              </div>
              <span className="text-sm font-medium text-muted-foreground">Completed</span>
            </div>
            <div className="cost-display text-success mb-1">
          ...
          <div className="bg-card border-2 border-primary/20 hover:border-primary rounded-2xl p-6 transition-colors">
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 bg-primary rounded-xl flex items-center justify-center">
                <BanknotesIcon className="w-6 h-6 text-primary-foreground" />
              </div>
              <span className="text-sm font-medium text-muted-foreground">Total Volume</span>
            </div>
            <div className="cost-display text-primary mb-1">
                ...
                <tbody>
                  {payments
                    ...
                    <tr key={payment.id} className="border-t border-border hover:bg-muted/30 transition-colors">
                      ...
                      <td className="p-4">
                        <div className="cost-display text-foreground">{formatCurrency(payment.amount)}</div>
                        {payment.invoiceNumber && (
                          <div className="text-technical text-muted-foreground">{payment.invoiceNumber}</div>
                        )}
                      </td>
                      <td className="p-4">
